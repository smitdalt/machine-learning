...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '/Users/jayurbain/Dropbox/Coursera/Udemy Deep Learning Part 1/machine_learning_examples/machine_learning_examples/tensorflow/MNIST_data/', 'Directory for data')
